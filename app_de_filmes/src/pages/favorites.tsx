      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
            Seus filmes e séries prediletos salvos em um só lugar.
          </p>
        </div>
        ...
        {favorites.length === 0 ? (
          <div className="flex flex-col items-center justify-center text-center py-20 bg-white dark:bg-[#161B22] border border-gray-200 dark:border-gray-800/40 rounded-2xl p-8 shadow-sm">
            <div className="w-16 h-16 rounded-full bg-[#E50914]/10 flex items-center justify-center mb-4 text-[#E50914]">
              <Heart className="w-8 h-8" />
            </div>
            <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Sua lista está vazia</h2>
            <p className="text-sm text-gray-500 dark:text-gray-400 max-w-sm mb-6">
              Navegue pelo catálogo e clique no ícone de coração em qualquer título para adicioná-lo aos favoritos.
            </p>
            <Link
              to="/"
              className="px-6 py-2.5 rounded-xl bg-[#E50914] hover:bg-[#b80710] text-white text-sm font-bold shadow-md cursor-pointer transition-colors"
            >
              Voltar ao Início
            </Link>
          </div>
